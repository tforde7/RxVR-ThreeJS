...
export default class ReceptionBox {

    constructor() {
        this.world = new World()
        this.scene = this.world.reception.scene
        this.resources = this.world.reception.resources
        this.debug = this.world.debug
        console.log('reception box')

        // Debug
        if (this.debug.active) {
            this.debugFolder = this.world.reception.debugFolder.addFolder('Box')
        }
